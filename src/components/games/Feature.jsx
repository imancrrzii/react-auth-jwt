...
const Feature = () => {
  return (
    <div className="w-full bg-white relative min-h-[600px] p-12">
      <div className="flex flex-col items-center overflow-visible relative">
        ...
        />
        <div className="w-full max-w-screen-xl mx-auto px-6 md:px-12 flex flex-col gap-8 items-center">
          {/* Heading */}
          ...
          {/* Fitur cards */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 justify-between items-center mt-6 w-full">
            <div className="flex flex-col space-y-4 bg-purple-100 p-6 items-start rounded-xl min-w-[210px]">
            ...
            <div className="flex-flex-col space-y-4 bg-pink-100 p-6 items-start rounded-xl min-w-[210px]">
              <div>
            ...
            <div className="flex-flex-col space-y-4 bg-blue-100 p-6 items-start rounded-xl min-w-[210px]">
              <div>
            ...
            <div className="flex-flex-col space-y-4 bg-orange-100 p-6 items-start rounded-xl min-w-[210px]">
              <div>
            ...
            <div className="flex-flex-col space-y-4 bg-green-100 p-6 items-start rounded-xl min-w-[210px]">
              <div>
