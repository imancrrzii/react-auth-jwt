...
const SifinaDashboard = () => {
  return (
    <div className="bg-white py-16">
      <div className="flex justify-between flex-col sm:flex-row p-0 lg:px-16 overflow-hidden relative">
        <img src={gelembung} alt="" className="absolute -bottom-60 left-0 z-30"/>
        <div className="flex justify-start pl-8 lg:pl-0 w-full md:w-2/5 lg:w-1/2">
          <img src={sifina1} alt="" className="w-64 lg:w-144" />
        </div>
        <div className="flex flex-col gap-6 p-10 lg:pr-16 lg:pl-0 lg:py-16 w-full md:w-3/5 lg:w-1/2 ">
          ...
          <div className="flex flex-col gap-2 item-center py-2">
            <div className="flex px-4 font-bold items-center">
              <label className="bg-sky-500 text-white px-2 py-2 rounded-md mr-4 self-start">
          ...
          <button type="button" class="
            ...
            "><div class="flex items-center gap-2"><p class="w-full text-center font-semibold">Masuk Aplikasi</p></div></button>
        </div>
