  ...
  return (
    <div className="bg-gray-50 py-16">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-16 mb-0 lg:mb-12 px-4 lg:px-0">
        ...
        <div className="flex flex-col gap-4 bg-white border-1 border-gray-100 px-6 py-10 w-full lg:w-[280px] rounded-4xl shadow-xs">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-16 mt-8 lg:mt-0 px-4 lg:px-0">
        ...
        <div className="flex flex-col gap-4 bg-white border-1 border-gray-50 px-6 py-10 w-full lg:w-[280px] rounded-4xl shadow-xs">
